...
export default function LandingPage() {
  ...
  const speakers = [
    ...
    },
    {
      ...
      bio: 'Основатель ДНК IT и AI Dev Team. 10+ лет в автоматизации, лично разобрал 200+ компаний. Создал команду, где 3 человека + 33 AI-агента заменяют IT-отдел за −80% стоимости.',
      achievements: ['200+ глубоких разборов бизнесов', '1000+ клиентов через ДНК IT', 'AI Dev Team: 3 человека + 33 агента'],
